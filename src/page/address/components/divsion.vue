		...
		<div class="divsion-select" v-show="regionShow">
				...
				<div class="forselect">
					<ul class="forProvince" >
						<li v-for="(value,index) in provinceList" @click="selectProvince(value,index)" :class="p == index ? 'active' : '' ">{{value.name}}</li>
					</ul>
					<ul class="forCity" >
						<li v-for="(value,index) in cityList" @click="selectCity(value,index)" :class="c == index ? 'active' : '' ">{{value.name}}</li>
					</ul>
					<ul class="forArea" >
						<li v-for="(value,index) in areaList" @click="selectArea(value,index)" :class="a == index ? 'active' : '' ">{{value}}</li>
					</ul>
				</div>
